package Bio::KBase::probe_match::Service;
...
sub call_method {
    ...
    my $ctx = Bio::KBase::probe_match::ServiceContext->new(client_ip => $self->_plack_req->address);
    
    my $args = $data->{arguments};

    # Service probe_match does not require authentication.
...
sub get_method
{
    ...
    {
	$self->exception('NoSuchMethod',
			 "'$method' is not a valid method in service probe_match.");
    }
...
package Bio::KBase::probe_match::ServiceContext;

use strict;

=head1 NAME

Bio::KBase::probe_match::ServiceContext
