...
from probe_matchImpl import probe_match
impl_probe_match = probe_match(config)
...
class Application(object):
    ...
    def __init__(self):
        ...
        self.rpc_service.add(impl_probe_match.match_probes_to_genome, name = 'probe_match.match_probes_to_genome',
